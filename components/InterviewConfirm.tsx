        ...
        <Container maxWidth="xs">
          ...
          >
            <Box>
              ...
              <p>
                <b>{interviewSessionData.interviewerName || interviewSessionData.interviewerNim}</b> akan berperan
                sebagai pewawancara yang mewawancarai{' '}
              ...
              <p>
                <i>Mock interview</i> ini terdiri dari beberapa bagian, yang akan ditampilkan satu persatu. Baca dan
                ikuti instruksi yang ditampilkan pada layar. Tolong diingat bahwa instruksi hanya bersifat sebagai
                pedoman saja, kamu diperbolehkan untuk menanyakan atau melakukan hal di luar instruksi tersebut.
              </p>
